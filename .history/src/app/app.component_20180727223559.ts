  ...
  template: `
    ...
    <vaadin-context-menu style="padding: 1rem 4rem;">
      ...
      <vaadin-item class="card-no-padding" style="max-width:15rem">
        ...
        <div class="contrast-5pct"><small style="font-size: .6375rem; line-height: 0; vertical-align: middle" class="space-xs secondary-text">Last Sync: {{lastReload}}</small></div>
      </vaadin-item>
    </vaadin-context-menu>`
})
