...
export class AppComponent {
  ...
  constructor( private StockApi: ApiService ) {
    StockApi.getStock().subscribe( data => {
      ...
      var twoAfterIndex = this.netGains.toString().indexOf('.') + 2;
      console.log(twoAfterIndex);
      console.log( this.netGains.toString().indexOf('.') + 2);
      this.netGains = parseInt( this.netGains.toString().substring( 0, 1));
    });
  }
}