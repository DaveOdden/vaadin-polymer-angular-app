  ...
  template: `
    ...
    <div style="padding: 1rem 4rem">
      <vaadin-context-menu>
        ...
        <template>
          <vaadin-list-box>
            <vaadin-item><iron-icon icon="vaadin:edit" class="tiny"></iron-icon>Edit</vaadin-item>
            <vaadin-item><iron-icon icon="vaadin:refresh" class="tiny"></iron-icon>Refresh</vaadin-item>
          </vaadin-list-box>
        </template>
