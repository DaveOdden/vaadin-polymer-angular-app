...
@Component({
  ...
  template: `
    <vaadin-tabs
      ...
      <vaadin-tab routerLink="/dashboard" routerLinkActive="selected">Dashboard</vaadin-tab>
      <vaadin-tab routerLink="/wealth" routerLinkActive="selected">Wealth</vaadin-tab>
      <vaadin-tab routerLink="/notes" routerLinkActive="selected">Notes</vaadin-tab>
    </vaadin-tabs>
